...
func TestNullableJSONArray(t *testing.T) {
	t.Run("json", func(t *testing.T) {
		js, err := NewNullableJSONArray[int]([]int{1, 2, 3})
		...
		assert.Panics(t, func() {
			MustNullableJSONArray[int](map[string]int{"invalid": 1})
		})
	})
